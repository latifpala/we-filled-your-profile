...
<div class="listing-links-container">
	...
	if($contacts) : 
		...
		if($show_details){ ?>
			...
			<ul class="listing-links contact-links">
				...
				<li><a href="<?php echo esc_url($website) ?>" target="_blank"  class="listing-links"><i class="fa fa-link"></i> <?php
	...
	<ul class="listing-links">
		...
		<li><a href="<?php echo esc_url($skype); ?>" target="_blank" class="listing-links-skype"><i class="fa fa-skype"></i> Skype</a></li>
		<?php endif; ?>
		<?php if(isset($whatsapp) && !empty($whatsapp)): ?>
		<li><a href="<?php echo esc_url($whatsapp); ?>" target="_blank" class="listing-links-whatsapp"><i class="fa fa-whatsapp"></i> WhatsApp</a></li>
		<?php endif; ?>
	</ul>
	<div class="clearfix"></div>
	<?php endif; ?>
